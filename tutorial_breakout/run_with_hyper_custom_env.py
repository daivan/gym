...
flag_col     = 'mono_3dim'        # '3col', 'grey_3dim', 'grey_1dim',  'mono_3dim', 'mono_1dim'
...
eval_env = BreakoutObservationWrapper(env,flag_col, 
                 flag_dim,
                 flag_predict)
...
#model_file = "3.3_aimbot_training_mono_1dim_trim_predict_3fs_0es_seed124_1e7"
